...
- Only the Phase 1E pure tile geometry primitives, Phase 1F build/action catalogue classification helpers, Phase 1G disabled-unit membership checks, Phase 1I build availability preflight V1 boundary checks, and Phase 1J map surface/context primitives are implemented; broader OpenFront gameplay mechanics are not implemented yet.
